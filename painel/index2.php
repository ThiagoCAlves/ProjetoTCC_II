						...
						<ul class="sidebar-menu">
                            ...
                            <li class="treeview">
								...
								<ul class="treeview-menu">
									<li><a href="index2.php?pagina=projeto_usuario"><i class="fa fa-angle-right"></i> Meu Projeto</a></li>
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									<li><a href="index2.php?pagina=calendario_usuario"><i class="fa fa-angle-right"></i> Calendário</a></li>
									<li><a href="index2.php?pagina=financeiro"><i class="fa fa-angle-right"></i> Pagamentos</a></li>
								</ul>
							</li>
                            <li class="treeview">
								<a href="#">
								...
								<ul class="treeview-menu">
									<li><a href="index2.php?pagina=biblioteca_usuario"><i class="fa fa-angle-right"></i> Repositório</a></li>
							...
							<ul class="dropdown-menu">
								<li>
									<div class="notification_header">
										<h3>Você tem 2 Mensagens!</h3>
									</div>
								</li>
								<li><a href="#">
									<div class="user_img"><img src="images/1.jpg" alt=""></div>
									<div class="notification_desc">
										<p>1º Etapa Projeto</p>
