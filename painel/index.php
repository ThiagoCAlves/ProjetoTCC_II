			...
			<aside class="sidebar-left" style=" height:100%;">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span><img src="../img/bsh/Icone BS HUB Branco.png" width="20%" > </span>BS Hub<span class="dashboard_text"><?php echo $nome_sistema ?></span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									<li><a href="index.php?pagina=usuarios"><i class="fa fa-angle-right"></i> Cadastrar Clientes</a></li>
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									<li><a href="index.php?pagina=criar_projeto"><i class="fa fa-angle-right"></i> Criar Projetos</a></li>
								</ul>
							</li>
							<li class="treeview">
								<a href="#">
								...
								<ul class="treeview-menu">
									<li><a href="index.php?pagina=calendario"><i class="fa fa-angle-right"></i> Calendário</a></li>
								</ul>
							</li>
							<li class="treeview">
								<a href="#">
								...
								<ul class="treeview-menu">
									<li><a href="index.php?pagina=chat-conversa"><i class="fa fa-angle-right"></i> Criar Cobranças</a></li>
								</ul>
							</li>
							<li class="treeview">
