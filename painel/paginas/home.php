...
<div class="col_3">
		<div class="col-md-3 widget widget1">
			<a href="index.php?pagina=usuarios"><div class="r3_counter_box">
				<i class="pull-left fa fa-group user1 icon-rounded"></i>
				<div class="stats">
					<h5><strong>Cadastrar Clientes</strong></h5>
				</div>
			</div></a>
		</div>
		...
		<div class="col-md-3 widget widget1" >
			<div class="r3_counter_box">
				<i class="pull-left fa fa-briefcase user2 icon-rounded"></i>
				<div class="stats">
					<h5><strong>Criar Projeto</strong></h5>
				</div>
			</div>
		</div>
		...
		<div class="col-md-3 widget widget1" >
			<div class="r3_counter_box">
				<i class="pull-left fa fa-photo user3 icon-rounded"></i>
				<div class="stats">
					<h5><strong>Portifólios</strong></h5>
				</div>
			</div>
		</div>
